...
base::dir.create('data/raw data/macdonald_2023_understory', showWarnings = FALSE)
base::saveRDS(
   ...
   file = 'data/raw data/macdonald_2023_understory/rdata.rds'
)
