...
if (!file.exists("data/raw data/edgar_2022_fish/rdata.rds")) {
   base::dir.create(path = "data/raw data/edgar_2022_fish", showWarnings = FALSE)
   base::saveRDS(
      ...
      ,
      file = "data/raw data/edgar_2022_fish/rdata.rds"
   )
}
