...
if (!file.exists("data/raw data/egar_2022_cryptic/rdata.rds")) {
   base::dir.create(path = "data/raw data/egar_2022_cryptic", showWarnings = FALSE)
   base::saveRDS(
      ...
      file = "data/raw data/egar_2022_cryptic/rdata.rds"
   )
}
