...
if (!file.exists("data/raw data/edgar_2022_macroinvertebrates/rdata.rds")) {
   base::dir.create(path = "data/raw data/edgar_2022_macroinvertebrates", showWarnings = FALSE)
   base::saveRDS(
      ...
      file = "data/raw data/edgar_2022_macroinvertebrates/rdata.rds"
   )
}
