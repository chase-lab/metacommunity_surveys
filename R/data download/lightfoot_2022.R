...
if (!base::file.exists("./data/raw data/lightfoot_2022/rdata.rds")) {
   curl::curl_download(url = "https://portal.edirepository.org/nis/dataviewer?packageid=knb-lter-jrn.210007001.38&entityid=731f52d77045dfc5957589d35c2e6227",destfile = "./data/cache/lightfoot_2022/lizard_pitfall_data_89-06.csv", mode = "wb")
