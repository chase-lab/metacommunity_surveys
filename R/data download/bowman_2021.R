...
if (!file.exists('data/raw data/bowman_2021/rdata.rds')) {
   if (!file.exists('data/cache/bowman_2021_species_composition.csv')) {
      curl::curl_download(url = 'https://portal.edirepository.org/nis/dataviewer?packageid=knb-lter-nwt.202.2&entityid=3ebfe6838cc9717c95906036de9efc59',
   ...
   if (!file.exists('data/cache/bowman_2021_taxon_codes.csv')) {
      curl::curl_download(url = 'https://portal.edirepository.org/nis/dataviewer?packageid=knb-lter-nwt.202.2&entityid=d5d6f61323e53d8b2879d04bad5e0ed1',
