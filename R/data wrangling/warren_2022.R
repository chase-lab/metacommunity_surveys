...
data.table::setnames(ddata, c("location_type", "site_code", "common_name"), c("regional", "local", "species"))
...
meta[, ":="(
  ...
  #difficult:  as far as the eye can see ("Open Radius.")
  alpha_grain = 1L ,
  alpha_grain_unit = "m2",
