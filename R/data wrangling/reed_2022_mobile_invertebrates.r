dataset_id <- "reed_2022_mobile_invertebrates"
...
ddata <- ddata[COARSE_GROUPING == "MOBILE INVERT"]
...
meta[, ":="(
   ...
   comment_standardisation = "Dataset split in different scripts by fish, sessile invertebrates, mobile invertebrates and macroalgae. Sessile and Mobile Invertebrates defined by column COARSE_GROUPING",
