dataset_id <- "reed_2022_sessile_invertebrates"
...
##split dataset ----
#group sessile invertebrates
ddata <- ddata[COARSE_GROUPING == "SESSILE INVERT"]

## sum percent_coverage, WM_GM2, DM_GM2, SFDM, AFDM and density measurement collecting all pa info ----
ddata[, value := sum(PERCENT_COVER, DENSITY, WM_GM2, DM_GM2, SFDM, AFDM,  na.rm = TRUE),
      by = c("SITE", "TRANSECT", "SP_CODE", "YEAR", "MONTH", "day")]
...
meta[, ":="(
   ...
   comment_standardisation = "percent_coverage, WM_GM2, DM_GM2, SFDM, AFDM and density pooled together and translated to presence absence data. dataset split in different scripts by fish, sessile invertebrates, mobile invertebrates and macroalgae. Sessile and Mobile Invertebrates defined by column COARSE_GROUPING",
