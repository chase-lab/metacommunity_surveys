dataset_id <- 'rennie_2017_finegrain'
...
meta[, ":="(
   ...
   comment = "Data were downloaded from https://catalogue.ceh.ac.uk/documents/b98efec8-6de0-4e0c-85dc-fe4cdf01f086. Authors measured plant species presence in 12 sites, each sampled in at least 2 10*10m plots, each sampled in at least 2 40*40cm cells. The local scale is the cell and its name is constituted as plot_cell. Site coordinates were extracted from VF_DATA_STRUCTURE.rtf found in the Supporting documentation.",
