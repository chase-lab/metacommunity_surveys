...
=======
ddata <- base::readRDS("./data/raw data/wright_2021/rdata.rds")
taxo <- base::readRDS("./data/raw data/wright_2021/species.rds")
  

#drop("code", "genus", "species", "author")
#drop("month", "start_date", "end_date", "direction", "color")
