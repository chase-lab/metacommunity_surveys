...
# Standardising data ----
## in 1967, in the Athabasca site, 397 of the 400 quadrats were sampled so we kept only the same 397 quadrats in all sites and all years. data.table style join
