...
data.table::setDT(ddata)[value >= 0, pa:=paste0(1L)]
data.table::setDT(ddata)[value == 0, pa:=paste0(0L)]
...
#split dataset: 
#group fish
ddata_fish <- ddata[TAXON_KINGDOM == "Animalia" & TAXON_PHYLUM == "Chordata" & (TAXON_CLASS == "Elasmobranchii" | TAXON_CLASS == "Actinopterygii")]
...
#difficult aka different coordinates for differen local scales 
